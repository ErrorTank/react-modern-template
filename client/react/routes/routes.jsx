        ...
        return(
            <div id="main-route">
                ...
                <div style={{marginBottom: "15px"}}>
                    ...
                    {validHash === 2 && <span style={{color: "#28a745", verticalAlign: "top"}}><i className="fas fa-check-circle"></i></span> }
                    {validHash === 1 && <span style={{color: "#dc3545", verticalAlign: "top"}}><i className="fas fa-times-circle"></i></span> }
                </div>
                <div style={{marginBottom: "15px"}}>
                    ...
                    {validSign === 2 && <span style={{color: "#28a745", verticalAlign: "top"}}><i className="fas fa-check-circle"></i></span> }
                    {validSign === 1 && <span style={{color: "#dc3545", verticalAlign: "top"}}><i className="fas fa-times-circle"></i></span> }
                </div>
            </div>
        );
    }
